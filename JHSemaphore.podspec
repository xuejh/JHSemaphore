#
#  Be sure to run `pod spec lint JHSemaphore.podspec' to ensure this is a
...
JHSemaphore 是对iOS信号量应用的简单封装
  ...
  # Or just: s.author    = "xuejh"
  # s.authors            = { "xuejh" => "327646128@qq.com" }
  # s.social_media_url   = "http://twitter.com/xuejh"
